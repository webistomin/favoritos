!(function () {
  ...
  (e.version = '2.3.7'),
    ...
    (e.idf = function (e, t) {
      let r = 0;
      for (const i in e) '_index' != i && (r += Object.keys(e[i]).length);
    ...
    (e.stemmer = (function () {
      const e = {
        ...
        I = function (r) {
          ...
          (o = P).test(r) &&
            ((i = (I = o.exec(r))[1]), (a = d), (u = O), ((o = h).test(i) || (a.test(i) && !u.test(i))) && (r = i));
          return (
            (a = h),
            r.endsWith('ll') && a.test(r) && ((o = g), (r = r.replace(o, ''))),
    ...
    (e.TokenSet.Builder.prototype.minimize = function (e) {
      for (let t = this.uncheckedNodes.length - 1; e <= t; t--) {
    ...
    (e.Index.prototype.query = function (t) {
      ...
      for (u = 0; u < C.length; u++) {
        const D = (j = e.FieldRef.fromString(C[u])).docRef;
    ...
    (e.Builder.prototype.field = function (e, t) {
      if (e.includes('/')) throw new RangeError("Field '" + e + "' contains illegal character '/'");
      this._fields[e] = t || {};
    }),
    ...
    (e.Builder.prototype.calculateAverageFieldLengths = function () {
      ...
      const u = Object.keys(this._fields);
...
!(function (typedoc) {
      ...
      return (
        ...
        (EventTarget.prototype.removeEventListener = function (type, callback) {
          if (type in this.listeners)
            for (let stack = this.listeners[type], i = 0, l = stack.length; i < l; i++)
              if (stack[i] === callback) return void stack.splice(i, 1);
        }),
        (EventTarget.prototype.dispatchEvent = function (event) {
          if (!(event.type in this.listeners)) return !0;
          for (let stack = this.listeners[event.type].slice(), i = 0, l = stack.length; i < l; i++)
  ...
  (function (typedoc) {
    const Viewport = (function (_super) {
      function Viewport() {
      ...
      return (
        ...
        (Viewport.prototype.triggerResize = function () {
          const event = new CustomEvent('resize', { detail: { width: this.width, height: this.height } });
        ...
        (Viewport.prototype.onScroll = function () {
          ...
          const event = new CustomEvent('scroll', { detail: { scrollTop: this.scrollTop } });
  ...
  (function (typedoc) {
    (typedoc.pointerDown = 'mousedown'),
      ...
      document.addEventListener(typedoc.pointerDown, function (e) {
        ...
        const t = 'touchstart' == typedoc.pointerDown ? e.targetTouches[0] : e;
      ...
      return (
        ...
        (MenuHighlight.prototype.onResize = function () {
          for (var anchor, index = 0, count = this.anchors.length; index < count; index++) {
            const rect = (anchor = this.anchors[index]).anchor.getBoundingClientRect();
            anchor.position = rect.top + document.body.scrollTop;
          }
          this.anchors.sort(function (a, b) {
            return a.position - b.position;
          });
          const event = new CustomEvent('scroll', { detail: { scrollTop: typedoc.viewport.scrollTop } });
          this.onScroll(event);
        }),
      ...
      const Search = (function (_super) {
        ...
        return (
          ...
          (Search.prototype.updateResults = function () {
            if (
              ...
              for (let i = 0, c = Math.min(10, res.length); i < c; i++) {
                let row = this.data.rows[Number(res[i].ref)],
          ...
          (Search.prototype.setCurrentResult = function (dir) {
            ...
            if (current) {
              const rel = 1 == dir ? current.nextElementSibling : current.previousElementSibling;
        ...
        return (
          ...
          (Signature.prototype.setIndex = function (index) {
            if (
              ...
              if (-1 < this.index) {
                const from_1 = this.groups[this.index];
